var Gitment = function (a) {
	...
	"use strict";
	Object.defineProperty(b, "__esModule", {value: !0}), b.LS_ACCESS_TOKEN_KEY = "gitment-comments-token", b.LS_USER_KEY = "gitment-user-info", b.NOT_INITIALIZED_ERROR = new Error("Comments Not Initialized")
}, function (a, b, c) {
	"use strict";
	!function (c) {
		function i(a) {
		...
		function j(a, b, c) {
			var d = "string" == typeof a ? a : a.name || "<unnamed action>", e = "function" == typeof a ? a : b,
		...
		function W(a, b, c) {
			...
			if (void 0 === b && (b = !0), void 0 === c && (c = []), I(a)) {
				if (b && null === c && (c = []), b && null !== a && "object" === ("undefined" == typeof a ? "undefined" : d(a))) for (f = 0, g = c.length; g > f; f++) if (c[f][0] === a) return c[f][1];
				if (Kc(a)) {
		...
		function bb(a, b, c, d) {
			var g, h, i, j, k, e = bc() && !!a, f = 0;
			if (e) {
				if (f = Date.now(), g = d && d.length || 0, h = new Array(g), g > 0) for (i = 0; g > i; i++) h[i] = d[i];
				dc({type: "action", name: a, fn: b, object: c, arguments: h})
			}
			return j = xb(), Nb(), k = gb(!0), {prevDerivation: j, prevAllowStateChanges: k, notifySpy: e, startTime: f}
		}

		function cb(a) {
			hb(a.prevAllowStateChanges), Ob(), yb(a.prevDerivation), a.notifySpy && fc({time: Date.now() - a.startTime})
		}
		...
		function qb(a) {
			...
			switch (a.dependenciesState) {
				...
				case nb.POSSIBLY_STALE:
					for (b = xb(), c = a.observing, d = c.length, e = 0; d > e; e++) if (f = c[e], mb(f)) {
						try {
							f.get()
						} catch (g) {
							return yb(b), !0
		...
		function ub(a) {
			var d, e, f, g, b = a.observing, c = a.observing = a.newObserving;
		...
		function zb(a) {
			var b, c;
			if (a.dependenciesState !== nb.UP_TO_DATE) for (a.dependenciesState = nb.UP_TO_DATE, b = a.observing, c = b.length; c--;) b[c].lowestObserverState = nb.UP_TO_DATE
		}
		...
		function Rb(a) {
			var b, c, d;
			if (a.lowestObserverState !== nb.STALE) for (a.lowestObserverState = nb.STALE, b = a.observers, c = b.length; c--;) d = b[c], d.dependenciesState === nb.UP_TO_DATE && d.onBecomeStale(), d.dependenciesState = nb.STALE
		}

		function Sb(a) {
			var b, c, d;
			if (a.lowestObserverState !== nb.STALE) for (a.lowestObserverState = nb.STALE, b = a.observers, c = b.length; c--;) d = b[c], d.dependenciesState === nb.POSSIBLY_STALE ? d.dependenciesState = nb.STALE : d.dependenciesState === nb.UP_TO_DATE && (a.lowestObserverState = nb.UP_TO_DATE)
		}

		function Tb(a) {
			var b, c, d;
			if (a.lowestObserverState === nb.UP_TO_DATE) for (a.lowestObserverState = nb.POSSIBLY_STALE, b = a.observers, c = b.length; c--;) d = b[c], d.dependenciesState === nb.UP_TO_DATE && (d.dependenciesState = nb.POSSIBLY_STALE, d.onBecomeStale())
		}
		...
		function Wb(a) {
			return Cb.globalReactionErrorHandlers.push(a), function () {
		...
		function $b() {
			var a, b, c, d, e;
			for (Cb.isRunningReactions = !0, a = Cb.pendingReactions, b = 0; a.length > 0;) for (++b === Xb && (console.error("Reaction doesn't converge to a stable state after " + Xb + " iterations." + (" Probably there is a cycle in the reactive function: " + a[0])), a.splice(0)), c = a.splice(0), d = 0, e = c.length; e > d; d++) c[d].runReaction();
		...
		function cc(a) {
			var b, c, d;
			if (Cb.spyListeners.length) for (b = Cb.spyListeners, c = 0, d = b.length; d > c; c++) b[c](a)
		}
		...
		function jc(a, b) {
			var d, e, f, c = xb();
			try {
				if (d = a.interceptors) for (e = 0, f = d.length; f > e && (b = d[e](b), vd(!b || b.type, "Intercept handlers should return nothing or a change object"), b); e++) ;
				return b
			} finally {
				yb(c)
			}
		...
		function mc(a, b) {
			var e, f, c = xb(), d = a.changeListeners;
			if (d) {
		...
		function Fc(a) {
			var b = Gc(a), c = Hc(a);
			Object.defineProperty(Dc.prototype, "" + a, {enumerable: !1, configurable: !0, set: b, get: c})
		}

		function Gc(a) {
			return function (b) {
				var e, f, g, c = this.$mobx, d = c.values;
				if (a < d.length) {
					if (sb(c.atom), e = d[a], hc(c)) {
						if (f = jc(c, {type: "update", object: c.array, index: a, newValue: b}), !f) return;
						b = f.newValue
					}
		...
		function Rc(a, b, c, d) {
			...
			if ("value" in c) if (rc(c.value)) {
				var e = c.value;
				Sc(a, b, e.initialValue, e.enhancer)
			} else k(c.value) && c.value.autoBind === !0 ? l(a.target, b, c.value.originalFn) : mb(c.value) ? Uc(a, b, c.value) : Sc(a, b, c.value, d); else Tc(a, b, c.get, c.set, !1, !0)
		}

		function Sc(a, b, c, d) {
			var e, f;
			if (Md(a.target, b), hc(a)) {
				if (e = jc(a, {object: a.target, name: b, type: "add", newValue: c}), !e) return;
				c = e.newValue
			}
		...
		function Zc(a, b, c) {
			var f, g, h, d = a.$mobx, e = d.values[b];
			if (hc(d)) {
				if (f = jc(d, {type: "update", object: a, name: b, newValue: c}), !f) return;
				c = f.newValue
			}
		...
		function $c(a, b, c, d) {
			var e = kc(a), f = bc(), g = e || f ? {type: "add", object: b, name: c, newValue: d} : null;
		...
		function hd(a, b, c, d, e) {
			function f(f, g, h, i, j) {
				...
				return void 0 === j && (j = 0), vd(e || kd(arguments), "This function is a decorator, but it wasn't invoked like a decorator"), h ? (Hd(f, "__mobxLazyInitializers") || Jd(f, "__mobxLazyInitializers", f.__mobxLazyInitializers && f.__mobxLazyInitializers.slice() || []), l = h.value, m = h.initializer, f.__mobxLazyInitializers.push(function (b) {
					...
					enumerable: d, configurable: !0, get: function () {
		...
		function nd(a) {
			...
			return Kd(a, "next", function () {
				return b++, {done: b >= this.length, value: b < this.length ? this[b] : void 0}
			}), a
		}
		...
		function Jd(a, b, c) {
			Object.defineProperty(a, b, {enumerable: !1, writable: !0, configurable: !0, value: c})
		}

		function Kd(a, b, c) {
			Object.defineProperty(a, b, {enumerable: !1, writable: !1, configurable: !0, value: c})
		}
		...
		function Pd(a, b) {
			var c = "isMobX" + a;
			return b.prototype[c] = !0, function (a) {
				return Cd(a) && a[c] === !0
			}
		}
		...
		var f, g, h, r, s, t, J, K, L, M, N, P, Q, ib, jb, kb, lb, mb, nb, ob, Ab, Bb, Cb, Ub, Xb, Yb, _b, ec, yc, zc,
			Ac, Bc, Cc, Dc, Ec, Jc, Lc, Mc, Oc, Pc, Vc, Wc, _c, bd, cd, dd, md, pd, rd, wd, zd, Gd,
		...
		Object.defineProperty(b, "__esModule", {value: !0}), Fb(), b.extras = {
			...
			var f = d && 1 === d.length ? d[0] : c.name || b || "<unnamed action>", g = h(f, c);
			Jd(a, b, g)
		}, function (a) {
			return this[a]
		}, function () {
			...
			return a.prototype.onBecomeUnobserved = function () {
			...
			return a.prototype.onBecomeStale = function () {
				...
				var b;
				if (a) b = tb(this, this.derivation, this.scope); else try {
		...
		}(), lb.prototype[Td()] = lb.prototype.valueOf, mb = Pd("ComputedValue", lb), function (a) {
			...
			return a.prototype.onBecomeStale = function () {
				...
				Nb(), b = bc(), b && (c = Date.now(), dc({
					...
					type: "reaction",
					fn: a
				})), this._isRunning = !0, d = tb(this, a, void 0), this._isRunning = !1, this._isTrackPending = !1, this.isDisposed && vb(this), pb(d) && this.reportExceptionInDerivation(d.cause), b && fc({time: Date.now() - c}), Ob()
			...
			return a()
		}, _b = Pd("Reaction", Ub), ec = {spyReportEnd: !0}, b.spy = gc, b.asReference = nc, b.asStructure = oc, b.asFlat = pc, b.asMap = qc, b.isModifierDescriptor = rc, yc = 1e4, zc = function () {
			var a = !1, b = {};
			...
			return a.prototype.intercept = function (a) {
				...
				if (b = this.values.length, a !== b) if (a > b) {
				...
				var d = !this.owned && bc(), e = kc(this),
					f = e || d ? {object: this.array, type: "update", index: a, newValue: b, oldValue: c} : null;
				d && dc(f), this.atom.reportChanged(), e && mc(this, f), d && fc()
			}, a.prototype.notifyArraySplice = function (a, b, c) {
				var d = !this.owned && bc(), e = kc(this), f = e || d ? {
					object: this.array,
					type: "splice",
					index: a,
					removed: c,
			...
			return e(b, a), b.prototype.intercept = function (a) {
				...
				var d, e, f;
				for (void 0 === c && (c = 0), this.$mobx.atom.reportObserved(), d = this.$mobx.values, e = d.length, f = c; e > f; f++) if (a.call(b, d[f], f, this)) return d[f];
				return void 0
			...
			return a.prototype._has = function (a) {
				...
				if (this.assertValidKey(a), a = "" + a, c = this._has(a), hc(this)) {
					if (d = jc(this, {type: c ? "update" : "add", object: this, newValue: b, name: a}), !d) return this;
					b = d.newValue
				}
			...
			return e(b, a), b.prototype.set = function (a) {
				...
				return b && a({object: this, type: "update", newValue: this.value, oldValue: void 0}), lc(this, a)
			}, b.prototype.toJSON = function () {
				return this.get()
			}, b.prototype.toString = function () {
		...
		},rd = [],Object.freeze(rd),wd = [],zd = function () {
		},Gd = Object.prototype.hasOwnProperty,b.isArrayLike = Qd
	}.call(b, c(4))
}, function (a, b, c) {
	"use strict";

	function g(a, b) {
		var h, i, j, k, c = a.meta, d = a.user, f = a.reactions, g = document.createElement("div");
	...
	function h(a, b) {
		var l, m, n, o, p, q, r, s, t, u, v, w, c = a.meta, d = a.comments, g = a.commentReactions, h = a.currentPage,
			i = a.user, j = a.error, k = document.createElement("div");
		...
		if (q = document.createElement("ul"), q.className = "gitment-comments-list", d.forEach(function (a) {
			var h, j, k, l, c = new Date(a.created_at), d = new Date(a.updated_at), f = document.createElement("li");
	...
	function i(a, b) {
		var h, i, j, k, l, m, n, o, p, q, c = a.user, f = a.error, g = document.createElement("div");
	...
	function i(a) {
		return function (b) {
			var k, c = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {},
				...
				f = new XMLHttpRequest, g = localStorage.getItem(e.LS_ACCESS_TOKEN_KEY), i = "" + d + b, j = null;
			return ("GET" === a || "DELETE" === a) && (i += h.stringify(c)), k = new Promise(function (a, b) {
				f.addEventListener("load", function () {
					var e, c = f.getResponseHeader("content-type"), d = f.responseText;
	...
	var d, e, f, h;
	Object.defineProperty(b, "__esModule", {value: !0}), b.http = b.Query = b.isString = void 0, d = function () {
		function a(a, b) {
			var h, g, c = [], d = !0, e = !1, f = void 0;
			try {
				for (g = a[Symbol.iterator](); !(d = (h = g.next()).done) && (c.push(h.value), !b || c.length !== b); d = !0) ;
		...
		parse: function () {
			...
			return a ? (b = "?" === a[0] ? a.substring(1) : a, c = {}, b.split("&").forEach(function (a) {
				var b = a.split("="), e = d(b, 2), f = e[0], g = e[1];
				f && (c[f] = g)
			}), c) : {}
	...
	}, b.http = {get: i("GET"), post: i("POST"), "delete": i("DELETE"), put: i("PUT")}
}, function (a) {
	"use strict";
	...
	function m(a, b) {
		a[b] = function (c) {
			var d = g.getTargetContainer(c), f = a.theme[b] || a.defaultTheme[b];
	...
	var d = function () {
	...
	}(), e = c(1), f = c(0), g = c(3), h = c(2), i = j(h), l = "public_repo", n = function () {
		function a() {
			...
			try {
				h = localStorage.getItem(f.LS_USER_KEY), this.accessToken && h && Object.assign(d, JSON.parse(h), {fromCache: !0})
			} catch (j) {
		...
		return d(a, [{
			...
			key: "loginLink", get: function () {
				var a = "https://github.com/login/oauth/authorize", b = this.oauth.redirect_uri || window.location.href,
			...
			key: "useTheme", value: function () {
				var c, a = this, b = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {};
			...
			key: "markdown", value: function (a) {
				return g.http.post("/markdown", {text: a, mode: "gfm"})
			}
		}, {
			key: "createIssue", value: function () {
				var a = this, b = this.id, c = this.owner, d = this.repo, e = this.title, f = this.link, h = this.desc,
					i = this.labels;
			...
			key: "loadMeta", value: function () {
				var a = this, b = this.id, c = this.owner, d = this.repo;
				return g.http.get("/repos/" + c + "/" + d + "/issues", {creator: c, labels: b}).then(function (b) {
			...
			key: "loadComments", value: function () {
				...
				return this.getIssue().then(function (c) {
					return g.http.get(c.comments_url, {page: b, per_page: a.perPage}, "")
				}).then(function (b) {
			...
			key: "like", value: function () {
				var b, c, a = this;
				return this.accessToken ? (b = this.owner, c = this.repo, g.http.post("/repos/" + b + "/" + c + "/issues/" + this.state.meta.number + "/reactions", {content: "heart"}).then(function (b) {
			...
			key: "likeAComment", value: function (a) {
				var c, d, e, b = this;
				return this.accessToken ? (c = this.owner, d = this.repo, e = this.state.comments.find(function (b) {
					return b.id === a
				}), g.http.post("/repos/" + c + "/" + d + "/issues/comments/" + a + "/reactions", {content: "heart"}).then(function (c) {
					b.state.commentReactions[a].push(c), e.reactions.heart++
				})) : (alert("Login to Like"), Promise.reject())
			}
		}, {
			key: "unlikeAComment", value: function (a) {
				var b, c, d, e;
